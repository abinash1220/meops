    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    suffixIcon: const Image(
                        image: AssetImage("assets/icons/Group 225.png")),
          ...
          Obx(
            () => authController.loder.isTrue
                ? Padding(
                    padding:
                        const EdgeInsets.only(right: 15, left: 15, top: 150),
                    child: Container(
                        height: 43,
                        width: size.width,
                        decoration: BoxDecoration(
                    ...
                    child: InkWell(
                      onTap: () {
                        if (authController.dateOfBirthController.text.isNotEmpty &&
                            ...
                            authController
                                .professtionController.text.isNotEmpty &&
                            authController
