...
class TransactionsAndSavedCards extends StatefulWidget {
  const TransactionsAndSavedCards({super.key});

  @override
  State<TransactionsAndSavedCards> createState() =>
      _TransactionsAndSavedCardsState();
}

class _TransactionsAndSavedCardsState extends State<TransactionsAndSavedCards> {
  int index = 0;
  @override
