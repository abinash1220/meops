      ...
      body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
          ...
          child: SizedBox(
            height: 50,
            child: TextField(
              controller: authController.workLinkController1,
        ...
        if (isopen == true)
          Padding(
            ...
            child: SizedBox(
              height: 50,
              child: TextField(
                controller: authController.workLinkController2,
                decoration: InputDecoration(
                    isDense: true,
                    enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Upto 10 images(2 Mb each), 2 Videos (20 Mb each)",
                  style: primaryFont.copyWith(
                    color: Colors.grey,
                    fontWeight: FontWeight.w500,
                    fontSize: 10,
