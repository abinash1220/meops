...
class ClientUpdateKyc extends StatefulWidget {
  const ClientUpdateKyc({super.key});

  @override
  State<ClientUpdateKyc> createState() => _ClientUpdateKycState();
}

class _ClientUpdateKycState extends State<ClientUpdateKyc> {
