...
class _TermsOfConditionState extends State<TermsOfCondition> {
  ...
  void initState() {
    ...
    super.initState();
    authcontroller.helpLineListhttp();
  }
        ...
        child: Container(
                ...
                child: AppBar(
                  ...
                  elevation: 0,
                     ...
                     style: primaryFont.copyWith(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 22),
                     ),
                     centerTitle: true,
                ),
              ),
           ...
           child: SingleChildScrollView(
             child: Column(
              ...
              children: [
                ...
                Obx(()=>
                      Text(authcontroller.termsandcondition.value,
