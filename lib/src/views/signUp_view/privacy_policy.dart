      ...
      appBar: PreferredSize(
        ...
        child: Container(
         ...
         body: Padding(
           ...
           child: SingleChildScrollView(
             child: Column(
               ...
               children: [
                ...
                //  ),
                Obx(()=>
                    Text(authcontroller.privacyPolicy.toString(),
           ...
           // MEOps (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by MEOps.
           // This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, MEOps. By accessing or using our Services, you confirm that you have read, understood, and agreed to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.
           ...
           // ● Company: When this policy mentions “Company,” “we,” “us,” or “our,” it refers to Generation360™ Media Solutions Private Limited, 25, Sigaram Business Lounge, Next to Apollo Medical Center, Kumaran Colony Main Road, Vadapalani, Chennai, Tamil Nadu, 600026 that is responsible for your information under this Privacy Policy.
           // ● Country: The region where MEOps or the owners/founders of MEOps are based, in this case is India.
           // ● Customer: It refers to the company, organization or person that signs up to use the MEOps Service to manage the relationships with your consumers or service users.
           ...
           // ● Personnel: It refers to those individuals who are employed by MEOps or are under contract to perform a service on behalf of one of the parties.
           // ● Personal Data: It is any information that directly, indirectly, or in connection with other information — including a personal identification number — allows for the identification or identifiability of a natural person.
           ...
           // ● Phonebook (Contacts list): Your contacts list allows the app to be much easier to use by the user since accessing your contacts from the app makes you save tons of time.
           ...
           // When Do MEOps Use End User Information From Third-Parties?
           // MEOps will collect End User Data necessary to provide the MEOps services to our customers.
           ...
           // When Do MEOps Use Customer Information From Third Parties?
           // We receive some information from third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a MEOps customer, we receive information from a third party that provides automated fraud detection services to MEOps. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.
           ...
           // MEOps will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.
           ...
           // The rights you have to request updates or corrections to the information MEOps collects depend on your relationship with MEOps. Personnel may update or correct their information as detailed in our internal company employment policies.
           ...
           // Personnel
           // If you are a MEOps worker or applicant, we collect the information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.
           // You may contact us in order to (1) update or correct your information, (2) change your preferences with respect to communications and other information you receive from us, or (3) receive a record of the information relevant to you. Such updates, corrections, changes and deletions will have no effect on other information that we maintain, or information that we have provided to third parties in accordance with this Privacy Policy prior to such update, correction, change or deletion.
           
           // Sale of Business
           // We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of MEOps or any of its Corporate Affiliates (as defined herein), or that portion of MEOps or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.
           
           // Affiliates
           // We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with MEOps, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.
           ...
           // This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by MEOps. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.
           ...
           // You acknowledge and agree that MEOps shall not be responsible for any Third-Party Services, including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof. MEOps does not assume and shall not have any liability or responsibility to you or any other person or entity for any Third-Party Services.
           ...
           // ● Google Maps API
           // Google Maps API is a robust tool that can be used to create a custom map, a searchable map, check-in functions, display live data syncing with location, plan routes, or create a mash up just to name a few.
           ...
           // ● Sessions
           // MEOps uses "Sessions" to identify the areas of our website that you have visited. A Session is a small piece of data stored on your computer or mobile device by your web browser.
           
           // Contact Us
           // Don't hesitate to contact us if you have any questions. Our email: admin@generation360.in
